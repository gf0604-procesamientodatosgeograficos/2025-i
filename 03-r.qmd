...
3. Cree un programa (*script*) de R en RStudio (con la opción de menú *File - New File - R Script*) y escriba y ejecute parte del código utilizado en el capítulo anterior.
...
Por ejemplo, el siguiente bloque de código crea un objeto de tipo vector con el operador de asignación `<-`.

```{r}
#| label: ejemplo-objetos

# Crear un vector con elementos que van desde el 1 hasta el 10
v <- 1:10
